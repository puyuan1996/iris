...
class Trainer:
    def __init__(self, cfg: DictConfig) -> None:
        # TODO
        import os
        os.chdir('/Users/puyuan/code/iris')
        ...
        debug_dir = '/Users/puyuan/code/iris/outputs/debug'
        ...
        if not cfg.common.resume:
            ...
            shutil.copy(debug_dir+'/.hydra/config.yaml', config_path)
            wandb.save(str(config_path))
            shutil.copytree(src=(Path('/Users/puyuan/code/iris') / "src"), dst=debug_dir+"/src")
            shutil.copytree(src=(Path('/Users/puyuan/code/iris') / "scripts"), dst=debug_dir+"/scripts")
